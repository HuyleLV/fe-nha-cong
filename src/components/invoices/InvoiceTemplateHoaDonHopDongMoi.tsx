...
export default function InvoiceTemplateHoaDonHopDongMoi({ invoice }: Props) {
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, borderBottom: '2px solid #e6e6e6', paddingBottom: 12 }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 20, fontWeight: 800 }}>HÓA ĐƠN KÝ HỢP ĐỒNG THUÊ PHÒNG</div>
        ...
        <div style={{ marginTop: 12, background: '#fafafa', padding: 12, borderRadius: 6 }}>
          <div style={{ marginBottom: 6 }}><strong>Nội dung:</strong> Thu tiền khi ký hợp đồng thuê phòng mới</div>
