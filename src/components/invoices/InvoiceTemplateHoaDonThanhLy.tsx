...
export default function InvoiceTemplateHoaDonThanhLy({ invoice }: Props) {
      ...
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, borderBottom: '2px solid #e6e6e6', paddingBottom: 12 }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 18, fontWeight: 800 }}>HÓA ĐƠN THANH LÝ HỢP ĐỒNG</div>
        ...
        <div style={{ marginTop: 12, background: '#fafafa', padding: 12, borderRadius: 6 }}>
          <div style={{ marginBottom: 6 }}><strong>Nội dung:</strong> Thanh lý hợp đồng thuê phòng {invoice.note ?? ''}</div>
          <div style={{ marginBottom: 6 }}><strong>Khoản thu/phạt (nếu có):</strong> {invoice.penalty ?? ''}</div>
