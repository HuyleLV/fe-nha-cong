  ...
  return (
    <div className="mt-5 overflow-x-auto rounded bg-white shadow">
      <div className="min-w-full">
        <table className={`w-full text-[15px] table-fixed border-collapse [&_th]:border [&_th]:border-slate-200 [&_td]:border [&_td]:border-slate-200 [&_th]:bg-slate-100 [&_th]:text-center [&_td]:text-center`}>
