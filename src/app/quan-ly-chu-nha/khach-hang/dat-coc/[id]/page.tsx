...
export default function DepositEditPage() {
  ...
  // Load customers for this host (listAdminUsers returns host-relevant users when called with host token)
  useEffect(() => {
    (async () => {
      try {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        router.push('/quan-ly-chu-nha/khach-hang/dat-coc');
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-slate-200">
        <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" onClick={() => router.push('/quan-ly-chu-nha/khach-hang/dat-coc')} className="px-3 py-2 rounded-lg border border-slate-200 hover:bg-slate-50">Hủy</button>
          </div>
        </div>
      </div>
