  ...
  return (
    <div className="p-6">
      <Panel
        title="Thông báo"
        actions={(
          <button onClick={() => router.push('/quan-ly-chu-nha/thong-bao/create')} className="inline-flex items-center justify-center p-2 rounded-md bg-emerald-600 text-white" title="Thêm thông báo" aria-label="Thêm thông báo">
          ...
          {items.length === 0 ? (
            ...
            <tr key={it.id} className="border-b">
              ...
              <td className="py-3 text-sm text-slate-700 text-center">
                <button onClick={() => router.push(`/quan-ly-chu-nha/thong-bao/${it.id}`)} className="inline-flex items-center justify-center p-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700" title="Sửa">
