...
export default function InvoiceEditPage() {
    ...
    return (
      <div className="p-6 bg-white text-slate-800">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-right font-semibold">Tổng:</div>
        </div>
      </div>
    );
  }
  ...
  const save = async () => {
    ...
    try {
      ...
      router.push("/admin/tai-chinh/hoa-don");
    } catch (err) {
      console.error(err);
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium">Kỳ thanh toán <span className="text-red-500">*</span></label>
                ...
                <div>
                  <label className="block text-sm font-medium">Mẫu in hóa đơn <span className="text-red-500">*</span></label>
                  <select
