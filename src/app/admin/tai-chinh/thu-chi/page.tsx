  ...
  return (
    <div className="p-6">
      <Panel
        title="Thu chi"
        actions={(
          <button onClick={() => router.push('/admin/tai-chinh/thu-chi/create')} className="inline-flex items-center gap-2 bg-emerald-600 text-white p-2 rounded-md" title="Thêm thu chi">
