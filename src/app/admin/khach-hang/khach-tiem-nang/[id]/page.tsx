      ...
      if (!isEdit) {
        ...
        if (data.email) {
          try {
            ...
            const exists = (found.data || []).some((u: any) => String(u.email || '').toLowerCase() === String(data.email).toLowerCase());
            if (exists) {
        ...
        if (data.phone) {
          try {
            ...
            const exists = (found.data || []).some((u: any) => String(u.phone || '').replace(/\s+/g, '') === norm);
            if (exists) {
