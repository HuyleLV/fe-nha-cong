  ...
  return (
    <div className="p-6">
      <Panel
        title="Công việc"
        actions={(
          <button onClick={() => router.push('/admin/cong-viec/create')} className="inline-flex items-center justify-center p-2 rounded-md bg-emerald-600 text-white" title="Thêm công việc" aria-label="Thêm công việc">
          ...
          {items.length === 0 ? (
            ...
            <tr key={it.id} className="border-b">
              ...
              <td className="py-3 text-sm text-slate-700 text-center">
                <button onClick={() => router.push(`/admin/cong-viec/${it.id}`)} className="inline-flex items-center justify-center p-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700" title="Sửa">
